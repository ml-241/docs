...
<Markdown src="/products/sdks/snippets/install-cli.mdx"/>
  ...
  <CardGroup cols={3}>
    <Card title="TypeScript" icon={<img src="./images/icons/ts-light.svg" alt="TypeScript logo" className="h-10 w-10" noZoom />}  href="/sdks/generators/typescript/quickstart">
    </Card>
    <Card title="Python" icon={<img src="./images/icons/python-light.svg"/>} href="/sdks/generators/python/quickstart">
    </Card>
    <Card title="Go" icon={<img src="./images/icons/go-light.svg"/>} href="/sdks/generators/go/quickstart">
    </Card>
    <Card title="Java" icon={<img src="./images/icons/java-light.svg"/>} href="/sdks/generators/java/quickstart">
    </Card>
    <Card title=".NET" icon={<img src="./images/icons/csharp-light.svg"/>} href="/sdks/generators/csharp/quickstart">
    </Card>
    <Card title="PHP" icon={<img src="./images/icons/php-light.svg"/>} href="/sdks/generators/php/quickstart">
    </Card>
    <Card title="Ruby" icon={<img src="./images/icons/ruby-light.svg"/>} href="/sdks/generators/php/quickstart">
    </Card>
  </CardGroup>
